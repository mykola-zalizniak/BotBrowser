...
Chrome 150 expands profile-backed browser-family consistency for CSS interface shape, supported feature inventory, computed style output, system colors, system fonts, and mobile CSS behavior. WebKit-family profiles apply their own profile family rules without changing Chromium-family sessions.
